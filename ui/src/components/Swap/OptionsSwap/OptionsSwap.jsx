...
const OptionsSwap = ({ slippage, setSlippage }) => {
  ...
  const slippageToolTip="With Slippage Tolerance, you can set the maximum % of price movement you can live with. Anything above that and your order will fail to execute."
  return (
    <motion.div
      layout
    ...
    >
      ...
      <div className="flex gap-2 items-center align-items">
        ...
        />
        <div className="z-20 w-[50%] text-xs mb-[100px] ml-[70px] bg-black text-white p-1 absolute rounded bg-opacity-60 shadow-xl hidden" id="tooltip" role="tooltip">
          </div>
      </div>
